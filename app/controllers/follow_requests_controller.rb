class FollowRequestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @follow_request.save
        format.html { redirect_to follow_request_url(@follow_request), notice: "FollowRequest was successfully created." }
  ...
  def update
    respond_to do |format|
      if @follow_request.update(follow_request_params)
        format.html { redirect_to follow_request_url(@follow_request), notice: "FollowRequest was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to follow_requests_url, notice: "FollowRequest was successfully destroyed." }
  ...
  private
    ...
    def follow_request_params
      params.require(:follow_request).permit(:sender_id, :recepient_id, :status)
    end
end
